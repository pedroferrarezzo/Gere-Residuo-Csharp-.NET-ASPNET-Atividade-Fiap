...
@CucumberOptions(
        ...
        glue = {"steps.usuario", "steps.agenda", "steps.bairro", "steps.morador", "steps.caminhao", "steps.motorista", "hook.agenda", "hook.bairro", "hook.morador", "hook.caminhao", "hook.motorista"},
